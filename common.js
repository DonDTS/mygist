$(document).ready(function() {
    ...
    $('#ip').hover(
        function() {
            var rgbColor3 = function get_random_color() {
        ...
        function() {
            var min = 5,
                max = 255;
            var rgbColor4 = 'rgb(' + (Math.floor(Math.random() * (max - min)) + min) + ',' + (Math.floor(Math.random() * (max - min)) + min) + ',' + (Math.floor(Math.random() * (max - min)) + min) + ')';
